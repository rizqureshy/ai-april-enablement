...
let players = [
  ...
  {name:'Elena Cazan', comp:8, qual:0},
  {name:'Eamonn Ward', comp:4, qual:0},
  {name:'Isabelle Puller', comp:5, qual:0},
  {name:'Jason Sherwood', comp:2, qual:0},
  {name:'Jenella Jimlani', comp:0, qual:0},
  {name:'Joseph Chan', comp:5, qual:0},
  {name:'Joy Parrish', comp:0, qual:0},
  {name:'Justin Sit', comp:3, qual:0},
  {name:'Kelly Grover', comp:2, qual:0},
  {name:'Kim Graham', comp:2, qual:0},
  {name:'Lorna Joiner', comp:11, qual:0},
  {name:'Michael Bourgeois', comp:14, qual:0},
  {name:'Morgan Gallegos', comp:1, qual:0},
  {name:'Paige Gregory', comp:3, qual:0},
  {name:'Rizwan Qureshy', comp:13, qual:0},
  {name:'Shiran Nizam', comp:2, qual:0},
  {name:'Sol Helou', comp:6, qual:0},
  {name:'Veronica John', comp:5, qual:0},
];
let editingId = null;
