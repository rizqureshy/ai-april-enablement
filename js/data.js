...
const CHS=[
  ...
  {day:4,  week:2, dow:1, cat:0, emoji:'\ud83c\udfad', diff:1, title:'Tone Tornado',
   ...
   details:'The funnier the better. Try to keep each version under 3 sentences. Bonus points if your team can guess which tone is which before you label them.',
   tools:['gpt','cop','cla']},
  {day:5,  week:2, dow:2, cat:5, emoji:'\ud83c\udf0c', diff:2, title:'Alternate Universe Office',
   ...
   details:'Describe your actual workspace in the prompt so the AI has real details to reimagine. The more specific you are, the better the results.',
   tools:['cop']},
  {day:6,  week:2, dow:3, cat:2, emoji:'\ud83c\udfb8', diff:2, title:'Mood Soundtrack',
   ...
   details:'Share the audio files or links in #ai-april. Include a quick note on which track you think nailed the mood best and why.',
   tools:['gem']},
  {day:7,  week:2, dow:4, cat:3, emoji:'\ud83d\udd04', diff:2, title:'Process Flow Animation',
   ...
   details:'Pick a real process from your day-to-day. Share the live HTML artifact or a screen recording of the animation in action.',
   tools:['cla']},
  {day:8,  week:2, dow:5, cat:4, emoji:'\ud83d\udcc8', diff:4, title:'Live Team Dashboard',
   ...
   details:'You have until Tuesday Apr 14th EOD to post your submission in #ai-april. Eamonn will grade and post results on Wednesday Apr 15th.',
  ...
  {day:9,  week:3, dow:1, cat:0, emoji:'\ud83d\udce2', diff:2, title:'Content Multiplier',
   ...
   details:'Use a single AI conversation to produce all 5 formats. Share the full output \u2014 it\'s interesting to see how the same idea morphs across formats.',
   tools:['gpt','cop']},
  {day:10, week:3, dow:2, cat:7, emoji:'\ud83c\udf1f', diff:3, title:'Your Origin Story',
   ...
   details:'Be honest and personal \u2014 the best stories come from real moments. Share both the written story and the 4 generated panels.',
   tools:['gpt']},
  {day:11, week:3, dow:3, cat:2, emoji:'\ud83c\udfa4', diff:3, title:'AI Original Song',
   ...
   details:'Submit both the lyrics and the generated audio. Genre is your choice \u2014 country, hip-hop, pop, lo-fi, whatever fits your story.',
   tools:['gpt','gem']},
  {day:12, week:3, dow:4, cat:3, emoji:'\ud83d\udcc5', diff:3, title:'Animated Project Timeline',
   ...
   details:'Use real project milestones if you can. Share a screen recording or live link showing the animation drawing itself out.',
   tools:['cla']},
  {day:13, week:3, dow:5, cat:0, emoji:'\ud83c\udfac', diff:4, title:'AI-Powered Project Pitch',
   ...
   details:'You have until Tuesday Apr 21st EOD to post your submission in #ai-april. Eamonn will grade and post results on Wednesday Apr 22nd.',
   tools:['cop','gpt','cla','gem'], mandatory:true},
