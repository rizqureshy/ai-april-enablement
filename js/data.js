...
const CHS=[
  ...
  {day:16, week:4, dow:3, cat:0, emoji:'\ud83d\udc19', diff:2, title:'Set Up Your GitHub',
   ...
   details:'The real skill: Getting comfortable with GitHub as a tool for managing and sharing your work.',
   tools:[]},
  {day:17, week:4, dow:4, cat:0, emoji:'\ud83d\ude80', diff:2, title:'Go Live',
   desc:'Take your best piece of work from the past three weeks \u2014 a dashboard, an animation, an app, a course \u2014 and publish it to GitHub Pages so it has a real live URL. Post the link in #ai-april.',
   details:'The real skill: Turning a file on your desktop into something the world can see.',
   tools:[]},
  {day:18, week:4, dow:5, cat:0, emoji:'\ud83c\udf10', diff:4, title:'Your AI April Portfolio',
   desc:'FRIDAY CHALLENGE \u2605 You have spent four weeks building things with AI. Now put it all in one place. Build and publish a personal AI portfolio page on GitHub Pages \u2014 showcase your best work from the month, the tools you used, what you learned, and what you\'d build next. It should look polished enough to share with your manager, your network, or a future employer. Post your live GitHub Pages link in #ai-april.',
